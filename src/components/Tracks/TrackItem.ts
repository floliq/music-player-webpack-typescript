        ...
        <li class="tracks__item flex">
            ...
            <div class="tracks__item__name">
                ...
                <h3 class="track__name">
                    <a class="track__name__link" href="#">${this.item.title}</a>
                </h3>
                <span class="track__author">${this.item.artist}</span>
                </div>
            </div>
            <div class="tracks__item__albom">${this.item.album}</div>
            <div class="tracks__item__data flex">
                <span class="data__text">${getAddedDate(
                  this.item.addedDate
                )}</span>
                <button class="track__like-btn ${
                  this.item.isLiked ? 'like-btn--active' : ''
                }">
                <svg
                    width="22"
                    height="18"
            ...
            <time class="tracks__item__time">${getTrackDuration(
              this.item.duration
            )}</time>
