            ...
            <ul class="tracks__list">
              <li class="tracks__item flex">
                ...
                <div class="tracks__item__name">
                  ...
                  <div class="track__content">
                    <h3 class="track__name">
                      <a class="track__name__link" href="#">In Bloom</a>
                    </h3>
                    <span class="track__author">Nirvana</span>
                  </div>
                </div>
                <div class="tracks__item__albom">Nirvana</div>
                <div class="tracks__item__data flex">
                  <span class="data__text">6 дней назад</span>
                ...
                <div class="tracks__item__drop">
                  ...
                  <div class="track__dropdown">
                    ...
                    <button class="track__delete-btn">
              ...
              <li class="tracks__item flex">
                ...
                <div class="tracks__item__name">
                  <img
                    class="track__img"
                    src="img/tracks%20(2).jpg"
                    alt="Gangsta's Paradise"
                  />
                  <div class="track__content">
                    <h3 class="track__name">
                      <a class="track__name__link" href="#"
                        >Gangsta's Paradise</a
                      >
                    </h3>
                    <span class="track__author">Coolio, L.V.</span>
                  </div>
                </div>
                ...
                <div class="tracks__item__name">
                  ...
                  <div class="track__content">
                    ...
                    <span class="track__author"
                      >Ludovico Einaudi, Czech National Symphony Orchestra</span
                    >
                  </div>
                </div>
              ...
              <li class="tracks__item flex">
                ...
                <div class="tracks__item__name">
                  <img
                    class="track__img"
                    src="img/tracks%20(4).jpg"
                    alt="Animal I Have Become"
                  />
                  <div class="track__content">
                    <h3 class="track__name">
                      <a class="track__name__link" href="#"
                        >Animal I Have Become</a
                      >
                    </h3>
                    <span class="track__author">Three Days Grace</span>
                  </div>
                </div>
              ...
              <li class="tracks__item flex">
                ...
                <div class="tracks__item__name">
                  <img
                    class="track__img"
                    src="img/tracks%20(5).jpg"
                    alt="When the Lights Come On"
                  />
                  <div class="track__content">
                    <h3 class="track__name">
                      <a class="track__name__link" href="#"
                        >When the Lights Come On</a
                      >
                    </h3>
                    <span class="track__author">IDLES</span>
                  </div>
                </div>
              ...
              <li class="tracks__item flex">
                ...
                <div class="tracks__item__name">
                  <img
                    class="track__img"
                    src="img/tracks%20(6).jpg"
                    alt="To The Skies From A Hillside"
                  />
                  <div class="track__content">
                    <h3 class="track__name">
                      <a class="track__name__link" href="#"
                        >To The Skies From A Hillside</a
                      >
                    </h3>
                    <span class="track__author">Maybeshewill</span>
                  </div>
                </div>
                <div class="tracks__item__albom">
              ...
              <li class="tracks__item flex">
                ...
                <div class="tracks__item__name">
                  <img
                    class="track__img"
                    src="img/tracks%20(7).jpg"
                    alt="Co-Conspirators"
                  />
                  <div class="track__content">
                    <h3 class="track__name">
                      <a class="track__name__link" href="#">Co-Conspirators</a>
                    </h3>
                    <span class="track__author">Maybeshewill</span>
                  </div>
                </div>
              ...
              <li class="tracks__item flex">
                ...
                <div class="tracks__item__name">
                  <img
                    class="track__img"
                    src="img/tracks%20(8).jpg"
                    alt="Surrounded By Spies"
                  />
                  <div class="track__content">
                    <h3 class="track__name">
                      <a class="track__name__link" href="#"
                        >Surrounded By Spies</a
                      >
                    </h3>
                    <span class="track__author">Placebo</span>
                  </div>
                </div>
